...
var Wizard = function (element, options) {
    ...
    //this.$element.on('click', '.btn-wizard', $.proxy(this.stepclicked, this));
    this.$element.on('finished.fu.wizard', 'div.wizard', function (evt, data) {
        alert("finished");
    });
...
Wizard.prototype = {
	...
	setState: function () {
		...
		this.$prevBtn.attr('disabled', (firstStep === true || canMovePrev === false || lastStep === true));
